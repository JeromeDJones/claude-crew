...
**Next up**: #21 teammate prompt parity *(in design — surfaced during #18)* · #19 tool-use events in dashboard · #16 message kind typing · #15 expanded subagent pack · #17 agent definition parity · #20 peer messaging between teammates *(idea)*
