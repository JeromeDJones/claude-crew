...
**Next up**: #17 agent definition parity *(SDD entering)* · #24 subagent-dispatch routing guard + post-output validation · #15 expanded subagent pack · #16 message kind typing · #25 startup diagnostics on dashboard *(idea, surfaced from #23 OQ-1)* · #20 peer messaging between teammates *(idea)*
