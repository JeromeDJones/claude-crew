...
**Next up**: #23 global skills for SDK teammates *(in design)* · #24 subagent-dispatch routing guard + post-output validation · #15 expanded subagent pack · #16 message kind typing · #17 agent definition parity · #20 peer messaging between teammates *(idea)*
