...
**Next up**: #14 token/cost telemetry **(in design — Phase 2 locked, Phase 3 task breakdown drafted)** · #15 expanded subagent pack · #16 message kind typing · #17 agent definition parity · #18 broker snapshot + dashboard polish · #19 tool-use events in dashboard
