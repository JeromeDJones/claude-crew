...
**Next up**: #14 token/cost telemetry **(implementation complete — pending manual test + merge)** · #15 expanded subagent pack · #16 message kind typing · #17 agent definition parity · #18 broker snapshot + dashboard polish · #19 tool-use events in dashboard · #20 peer messaging between teammates *(idea)*
...
### 2026-04-30 — #14 Token/Cost Telemetry — Design Locked
