...
Review task `broker-snapshot-slot-mapping` (index 0) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-broker-snapshot-slot-mapping-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-broker-snapshot-slot-mapping-build-0.md`

Find the breakout entry whose `name` is `broker-snapshot-slot-mapping`. Its `acceptanceTests`
