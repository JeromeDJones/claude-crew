...
Implement task `live-stderr-wiring-test` (index 3) of the breakout against
...
Task index: `3`
Description: Cycle-1 rework: address the slice-review REQUEST-CHANGES (HIGH-01 + MED-01) in the existing tests/test_live_stderr.py.
...
claude_crew/sdk_teammate.py (the _run() opts_kwargs construction, ~line 1432); the slice-review report at PRIOR_REPORT_PATH
...
Build report (write here): `/home/jerome/dev/claude-crew/.rr-worktrees/teammate-death-diagnostics/.rr/reports/teammate-death-diagnostics-task-live-stderr-wiring-test-build-1.md`

Prior build report (empty on cycle 0): /home/jerome/dev/claude-crew/.rr-worktrees/teammate-death-diagnostics/.rr/reports/teammate-death-diagnostics-task-live-stderr-wiring-test-slice-review-0.md
...
Run `cd "/home/jerome/dev/claude-crew/.rr-worktrees/teammate-death-diagnostics/.rr-worktrees/live-stderr-wiring-test"` before any file operation. Treat this path as binding.
...
6. Write the build report to `/home/jerome/dev/claude-crew/.rr-worktrees/teammate-death-diagnostics/.rr/reports/teammate-death-diagnostics-task-live-stderr-wiring-test-build-1.md` using the build-report
...
7. Emit this as the **final line** of your response — no trailing text after it:
   `RR-VERDICT: PASS|FAIL|BLOCKED <slug> <cycle> /home/jerome/dev/claude-crew/.rr-worktrees/teammate-death-diagnostics/.rr/reports/teammate-death-diagnostics-task-live-stderr-wiring-test-build-1.md`
