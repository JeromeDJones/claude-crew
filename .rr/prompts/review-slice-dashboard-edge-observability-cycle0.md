...
Review task `dashboard-edge-observability` (index 3) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/m2-edge-routing/.rr/reports/m2-edge-routing-task-dashboard-edge-observability-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/m2-edge-routing/.rr/reports/m2-edge-routing-task-dashboard-edge-observability-build-1.md`

Find the breakout entry whose `name` is `dashboard-edge-observability`. Its `acceptanceTests`
