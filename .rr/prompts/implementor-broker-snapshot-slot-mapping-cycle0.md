...
Implement task `broker-snapshot-slot-mapping` (index 0) of the breakout against
...
Task name: `broker-snapshot-slot-mapping`
Task index: `0`
Description: Add `topology_slot_to_teammate: Mapping[str, str]` to `BrokerSnapshot`
...
Build report (write here): `/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-broker-snapshot-slot-mapping-build-0.md`
...
`/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr-worktrees/broker-snapshot-slot-mapping`

Run `cd "/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr-worktrees/broker-snapshot-slot-mapping"` before any file operation. Treat this path as binding.
...
6. Write the build report to `/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-broker-snapshot-slot-mapping-build-0.md` using the build-report
...
7. Emit this as the **final line** of your response — no trailing text after it:
   `RR-VERDICT: PASS|FAIL|BLOCKED <slug> <cycle> /home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-broker-snapshot-slot-mapping-build-0.md`
