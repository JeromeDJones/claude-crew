...
Review task `unified-node-language-proposal` (index 2) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/shape-graphic-redesign/.rr/reports/shape-graphic-redesign-task-unified-node-language-proposal-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/shape-graphic-redesign/.rr/reports/shape-graphic-redesign-task-unified-node-language-proposal-build-1.md`
...
Find the breakout entry whose `name` is `unified-node-language-proposal`. Its `acceptanceTests`
