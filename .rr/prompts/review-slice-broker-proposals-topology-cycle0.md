...
Review task `broker-proposals-topology` (index 1) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-broker-proposals-topology-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-broker-proposals-topology-build-0.md`

Find the breakout entry whose `name` is `broker-proposals-topology`. Its `acceptanceTests`
