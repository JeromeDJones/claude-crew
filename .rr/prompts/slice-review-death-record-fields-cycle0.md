...
Review task `death-record-fields` (index 1) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/teammate-death-diagnostics/.rr/reports/teammate-death-diagnostics-task-death-record-fields-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/teammate-death-diagnostics/.rr/reports/teammate-death-diagnostics-task-death-record-fields-build-0.md`

Find the breakout entry whose `name` is `death-record-fields`. Its `acceptanceTests`
