...
Review task `pack-state-holder` (index 0) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/agent-pack-refresh/.rr/reports/agent-pack-refresh-task-pack-state-holder-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/agent-pack-refresh/.rr/reports/agent-pack-refresh-task-pack-state-holder-build-0.md`

Find the breakout entry whose `name` is `pack-state-holder`. Its `acceptanceTests`
