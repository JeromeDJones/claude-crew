...
Review task `broker-shutdown-all-parallel` (index 3) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/graceful-termination-memory-flush/.rr/reports/graceful-termination-memory-flush-task-broker-shutdown-all-parallel-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/graceful-termination-memory-flush/.rr/reports/graceful-termination-memory-flush-task-broker-shutdown-all-parallel-build-0.md`

Find the breakout entry whose `name` is `broker-shutdown-all-parallel`. Its `acceptanceTests`
