...
Review task `reshape-crew-scaffold` (index 2) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr/reports/m3-5-reshape-live-crew-task-reshape-crew-scaffold-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr/reports/m3-5-reshape-live-crew-task-reshape-crew-scaffold-build-0.md`
...
Find the breakout entry whose `name` is `reshape-crew-scaffold`. Its `acceptanceTests`
