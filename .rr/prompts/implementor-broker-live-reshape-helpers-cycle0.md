...
Implement task `broker-live-reshape-helpers` (index 1) of the breakout against
...
Task name: `broker-live-reshape-helpers`
Task index: `1`
Description: Add three minimal additive broker helpers in `claude_crew/broker.py`:
...
Build report (write here): `/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr/reports/m3-5-reshape-live-crew-task-broker-live-reshape-helpers-build-0.md`
...
`/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr-worktrees/broker-live-reshape-helpers`

Run `cd "/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr-worktrees/broker-live-reshape-helpers"` before any file operation. Treat this path as binding.
...
6. Write the build report to `/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr/reports/m3-5-reshape-live-crew-task-broker-live-reshape-helpers-build-0.md` using the build-report
...
7. Emit this as the **final line** of your response — no trailing text after it:
   `RR-VERDICT: PASS|FAIL|BLOCKED <slug> <cycle> /home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr/reports/m3-5-reshape-live-crew-task-broker-live-reshape-helpers-build-0.md`
