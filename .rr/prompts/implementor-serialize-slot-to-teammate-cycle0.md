...
Implement task `serialize-slot-to-teammate` (index 1) of the breakout against
...
Task name: `serialize-slot-to-teammate`
Task index: `1`
Description: Surface the aggregated mapping on the /api/state per-cli payload in
...
Build report (write here): `/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-serialize-slot-to-teammate-build-0.md`
...
`/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr-worktrees/serialize-slot-to-teammate`

Run `cd "/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr-worktrees/serialize-slot-to-teammate"` before any file operation. Treat this path as binding.
...
6. Write the build report to `/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-serialize-slot-to-teammate-build-0.md` using the build-report
...
7. Emit this as the **final line** of your response — no trailing text after it:
   `RR-VERDICT: PASS|FAIL|BLOCKED <slug> <cycle> /home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-serialize-slot-to-teammate-build-0.md`
