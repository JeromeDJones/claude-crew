...
Review task `responsive-grid-1024` (index 3) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/shape-graphic-redesign/.rr/reports/shape-graphic-redesign-task-responsive-grid-1024-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/shape-graphic-redesign/.rr/reports/shape-graphic-redesign-task-responsive-grid-1024-build-0.md`
...
Find the breakout entry whose `name` is `responsive-grid-1024`. Its `acceptanceTests`
