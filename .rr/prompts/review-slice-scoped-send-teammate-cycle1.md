...
Review task `scoped-send-teammate` (index 2) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/m2-edge-routing/.rr/reports/m2-edge-routing-task-scoped-send-teammate-slice-review-1.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/m2-edge-routing/.rr/reports/m2-edge-routing-task-scoped-send-teammate-build-1.md`

Find the breakout entry whose `name` is `scoped-send-teammate`. Its `acceptanceTests`
...
Cycle: 1
Prior report: /home/jerome/dev/claude-crew/.rr-worktrees/m2-edge-routing/.rr/reports/m2-edge-routing-task-scoped-send-teammate-slice-review-0.md
