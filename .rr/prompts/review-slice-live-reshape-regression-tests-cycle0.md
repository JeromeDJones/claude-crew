...
Review task `live-reshape-regression-tests` (index 4) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr/reports/m3-5-reshape-live-crew-task-live-reshape-regression-tests-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr/reports/m3-5-reshape-live-crew-task-live-reshape-regression-tests-build-0.md`
...
Find the breakout entry whose `name` is `live-reshape-regression-tests`. Its `acceptanceTests`
...
uv run pytest tests/test_live_reshape.py
