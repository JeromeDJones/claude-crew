...
Implement task `unify-topology-graph-component` (index 2) of the breakout against
...
Task name: `unify-topology-graph-component`
Task index: `2`
Description: Replace MiniGraph (~L1770) and TopologyEdgePanel (~L1565) in
...
claude_crew/ui/dashboard.html (MiniGraph ~L1770, TopologyEdgePanel ~L1565, renderMermaidBlocks ~L1055, mount ~L2735); doc/design/unified-topology-view-uxspec.md; doc/design/mockups/unified-topology-view-mock.html; tests/test_edge_dashboard.py; tests/dashboard/test_roster_spotlight.py; tests/dashboard/test_dashboard_mermaid.py; tests/test_dashboard_render.py
...
Build report (write here): `/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-unify-topology-graph-component-build-0.md`
...
`/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr-worktrees/unify-topology-graph-component`

Run `cd "/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr-worktrees/unify-topology-graph-component"` before any file operation. Treat this path as binding.
...
6. Write the build report to `/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-unify-topology-graph-component-build-0.md` using the build-report
...
7. Emit this as the **final line** of your response — no trailing text after it:
   `RR-VERDICT: PASS|FAIL|BLOCKED <slug> <cycle> /home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-unify-topology-graph-component-build-0.md`
