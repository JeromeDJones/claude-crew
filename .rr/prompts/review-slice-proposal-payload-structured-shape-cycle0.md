...
Review task `proposal-payload-structured-shape` (index 0) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/shape-graphic-redesign/.rr/reports/shape-graphic-redesign-task-proposal-payload-structured-shape-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/shape-graphic-redesign/.rr/reports/shape-graphic-redesign-task-proposal-payload-structured-shape-build-0.md`
...
Find the breakout entry whose `name` is `proposal-payload-structured-shape`. Its `acceptanceTests`
