...
Review task `per-scope-guidance-text` (index 1) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/multi-scope-agent-memory/.rr-worktrees/per-scope-guidance-text/.rr/reports/multi-scope-agent-memory-task-per-scope-guidance-text-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/multi-scope-agent-memory/.rr-worktrees/per-scope-guidance-text/.rr/reports/multi-scope-agent-memory-task-per-scope-guidance-text-build-0.md`

Find the breakout entry whose `name` is `per-scope-guidance-text`. Its `acceptanceTests`
