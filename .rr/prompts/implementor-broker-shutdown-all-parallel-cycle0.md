...
Implement task `broker-shutdown-all-parallel` (index 3) of the breakout against
...
Task name: `broker-shutdown-all-parallel`
Task index: `3`
Description: Add `graceful`/`flush_timeout` params to broker.shutdown_all and flush all memory-surface teammates in PARALLEL under ONE shared deadline (gather over begin_graceful_termination wrapped in a single asyncio.wait_for), then tombstone all. Not N×timeout sequential. Serialized after broker-graceful-kill because both edit broker.py.
...
Build report (write here): `/home/jerome/dev/claude-crew/.rr-worktrees/graceful-termination-memory-flush/.rr/reports/graceful-termination-memory-flush-task-broker-shutdown-all-parallel-build-0.md`
...
`/home/jerome/dev/claude-crew/.rr-worktrees/graceful-termination-memory-flush/.rr-worktrees/broker-shutdown-all-parallel`

Run `cd "/home/jerome/dev/claude-crew/.rr-worktrees/graceful-termination-memory-flush/.rr-worktrees/broker-shutdown-all-parallel"` before any file operation. Treat this path as binding.
...
6. Write the build report to `/home/jerome/dev/claude-crew/.rr-worktrees/graceful-termination-memory-flush/.rr/reports/graceful-termination-memory-flush-task-broker-shutdown-all-parallel-build-0.md` using the build-report
...
7. Emit this as the **final line** of your response — no trailing text after it:
   `RR-VERDICT: PASS|FAIL|BLOCKED <slug> <cycle> /home/jerome/dev/claude-crew/.rr-worktrees/graceful-termination-memory-flush/.rr/reports/graceful-termination-memory-flush-task-broker-shutdown-all-parallel-build-0.md`
