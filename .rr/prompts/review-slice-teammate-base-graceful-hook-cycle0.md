...
Review task `teammate-base-graceful-hook` (index 0) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/graceful-termination-memory-flush/.rr/reports/graceful-termination-memory-flush-task-teammate-base-graceful-hook-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/graceful-termination-memory-flush/.rr/reports/graceful-termination-memory-flush-task-teammate-base-graceful-hook-build-0.md`

Find the breakout entry whose `name` is `teammate-base-graceful-hook`. Its `acceptanceTests`
