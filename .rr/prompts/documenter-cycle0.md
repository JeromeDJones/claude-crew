...
`workflow-shape-composition-m0`, producing two artifacts in order before emitting your final
verdict:
...
- Spec under retrospect: `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/specs/workflow-shape-composition-m0.md`
- Reports directory: `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports`
- Workflow-retro enabled: `false`
- Workflow-retro user input block (populated by coordinator when enabled):



- Backlog-candidates output path: `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-retro-backlog-candidates.md`
- Doc-sync report output path: `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-retro-doc-sync.md`
- Prior report (empty on cycle 0): ``
- Already-routed retro findings — skip these in backlog-routing: `_None — fresh retro, nothing pre-routed._`
...
Synthesize backlog candidates and write them to `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-retro-backlog-candidates.md`.

Read the spec at `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/specs/workflow-shape-composition-m0.md` and every `*.md` under `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports`
...
h. **Write the candidates artifact** to `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-retro-backlog-candidates.md`.

If `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports` is empty, write the artifact with `## Outcome: no candidates`
and a note explaining the empty evidence base.

**Sub-step 2 — doc-sync**

Auto-apply accepted doc edits and emit the doc-sync checklist at
`/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-retro-doc-sync.md`.

Read the spec and every report in `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports` before applying changes.
...
2. `doc/ROADMAP.md`
3. `doc/features/FEATURE-workflow-shape-composition-m0.md`
4. `doc/BACKLOG.md`
...
- Any finding whose ID appears in `_None — fresh retro, nothing pre-routed._` is already routed.
  Do not re-propose it.
- Write the doc-sync checklist to `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-retro-doc-sync.md`.
- The checklist must include all five rows in canonical order.
- If `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports` is empty, write the checklist with
  `_No prior reports — no doc-sync candidates._` and `## Outcome: all candidates declined`.

Emit a final line `RR-VERDICT: PASS workflow-shape-composition-m0 0 /home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-retro-doc-sync.md`
on success, or `RR-VERDICT: REQUEST-CHANGES workflow-shape-composition-m0 0 /home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-retro-doc-sync.md`
