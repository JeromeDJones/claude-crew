...
Review task `serialize-slot-to-teammate` (index 1) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-serialize-slot-to-teammate-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-serialize-slot-to-teammate-build-0.md`

Find the breakout entry whose `name` is `serialize-slot-to-teammate`. Its `acceptanceTests`
