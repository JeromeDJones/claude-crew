...
Implement task `broker-proposals-topology` (index 1) of the breakout against
...
Task name: `broker-proposals-topology`
Task index: `1`
Description: Add ShapeProposal and Topology to claude_crew/broker.py plus the proposal
...
Tests`): 5,6,7 (see spec ## Acceptance Tests)
...
claude_crew/broker.py (the file you are modifying); claude_crew/shapes.py (parse_shape / Shape — already built by task 0)
...
Build report (write here): `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-broker-proposals-topology-build-0.md`
...
`/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr-worktrees/broker-proposals-topology`

Run `cd "/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr-worktrees/broker-proposals-topology"` before any file operation. Treat this path as binding.
...
6. Write the build report to `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-broker-proposals-topology-build-0.md` using the build-report
...
7. Emit this as the **final line** of your response — no trailing text after it:
   `RR-VERDICT: PASS|FAIL|BLOCKED <slug> <cycle> /home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-broker-proposals-topology-build-0.md`
