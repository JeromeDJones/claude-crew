...
Implement task `reshape-crew-scaffold` (index 2) of the breakout against
...
Task name: `reshape-crew-scaffold`
Task index: `2`
Description: Author the `reshape_crew` MCP tool skeleton in `claude_crew/server.py`:
...
Build report (write here): `/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr/reports/m3-5-reshape-live-crew-task-reshape-crew-scaffold-build-0.md`
...
`/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr-worktrees/reshape-crew-scaffold`

Run `cd "/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr-worktrees/reshape-crew-scaffold"` before any file operation. Treat this path as binding.
...
6. Write the build report to `/home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr/reports/m3-5-reshape-live-crew-task-reshape-crew-scaffold-build-0.md` using the build-report
...
7. Emit this as the **final line** of your response — no trailing text after it:
   `RR-VERDICT: PASS|FAIL|BLOCKED <slug> <cycle> /home/jerome/dev/claude-crew/.rr-worktrees/m3-5-reshape-live-crew/.rr/reports/m3-5-reshape-live-crew-task-reshape-crew-scaffold-build-0.md`
