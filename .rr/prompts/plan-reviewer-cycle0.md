...
Review the combined spec+breakout artifact at `/home/jerome/dev/claude-crew/.rr-worktrees/per-teammate-model-routing/.rr/specs/per-teammate-model-routing.md` for clarity, completeness, scope
