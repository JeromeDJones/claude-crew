...
Review the combined spec+breakout artifact at `/home/jerome/dev/claude-crew/.rr-worktrees/graceful-termination-memory-flush/.rr/specs/graceful-termination-memory-flush.md` for clarity, completeness, scope
