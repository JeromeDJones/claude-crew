...
Review task `broker-circuit-breaker` (index 1) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/m2-edge-routing/.rr/reports/m2-edge-routing-task-broker-circuit-breaker-slice-review-1.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/m2-edge-routing/.rr/reports/m2-edge-routing-task-broker-circuit-breaker-build-1.md`

Find the breakout entry whose `name` is `broker-circuit-breaker`. Its `acceptanceTests`
...
Cycle: 1
Prior report: /home/jerome/dev/claude-crew/.rr-worktrees/m2-edge-routing/.rr/reports/m2-edge-routing-task-broker-circuit-breaker-slice-review-0.md
