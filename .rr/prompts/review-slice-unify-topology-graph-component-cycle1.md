...
Review task `unify-topology-graph-component` (index 2) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-unify-topology-graph-component-slice-review-1.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-unify-topology-graph-component-build-1.md`

Find the breakout entry whose `name` is `unify-topology-graph-component`. Its `acceptanceTests`
...
Cycle: 1
Prior report: /home/jerome/dev/claude-crew/.rr-worktrees/unified-topology-view/.rr/reports/unified-topology-view-task-unify-topology-graph-component-slice-review-0.md
