...
Implement task `shape-schema-parser` (index 0) of the breakout against
...
Task name: `shape-schema-parser`
Task index: `0`
Description: Create claude_crew/shapes.py with the Shape, ShapeNode, ShapeEdge frozen
...
Tests`): 1,2,3,4 (see spec ## Acceptance Tests)
...
Build report (write here): `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-shape-schema-parser-build-0.md`
...
`/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr-worktrees/shape-schema-parser`

Run `cd "/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr-worktrees/shape-schema-parser"` before any file operation. Treat this path as binding.
...
6. Write the build report to `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-shape-schema-parser-build-0.md` using the build-report
...
7. Emit this as the **final line** of your response — no trailing text after it:
   `RR-VERDICT: PASS|FAIL|BLOCKED <slug> <cycle> /home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-shape-schema-parser-build-0.md`
