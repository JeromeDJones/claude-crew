...
Review task `shape-schema-parser` (index 0) of the breakout for slice
adherence, non-regression, and code-quality smoke. Your final-turn text is
the report. The coordinator persists it to:
`/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-shape-schema-parser-slice-review-0.md`
...
Build report: `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-shape-schema-parser-build-0.md`

Find the breakout entry whose `name` is `shape-schema-parser`. Its `acceptanceTests`
