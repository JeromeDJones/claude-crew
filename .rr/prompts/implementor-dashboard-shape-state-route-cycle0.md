...
Implement task `dashboard-shape-state-route` (index 3) of the breakout against
...
Task name: `dashboard-shape-state-route`
Task index: `3`
Description: Backend half of the shape-gate (the /api/state seam). Surface pending proposals
...
Tests`): 11,12 (see spec ## Acceptance Tests)
...
claude_crew/ui_server.py (the file you modify — _build_state/_build_local_instance, _proxy_artifact as the proxy template); claude_crew/broker.py (get_proposal/resolve_proposal/shape_proposals snapshot field — task 1); claude_crew/shapes.py (shape_to_mermaid — task 0)
...
Build report (write here): `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-dashboard-shape-state-route-build-0.md`
...
`/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr-worktrees/dashboard-shape-state-route`

Run `cd "/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr-worktrees/dashboard-shape-state-route"` before any file operation. Treat this path as binding.
...
6. Write the build report to `/home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-dashboard-shape-state-route-build-0.md` using the build-report
...
7. Emit this as the **final line** of your response — no trailing text after it:
   `RR-VERDICT: PASS|FAIL|BLOCKED <slug> <cycle> /home/jerome/dev/claude-crew/.rr-worktrees/workflow-shape-composition-m0/.rr/reports/workflow-shape-composition-m0-task-dashboard-shape-state-route-build-0.md`
